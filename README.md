...
Connections:
  ...
  - VDC Connection: Connect the positive terminal of the VDC source to the VDD pin of the inverter and the negative terminal to the gnd, This supplies power to the inverter.
